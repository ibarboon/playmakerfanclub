...
<!--<![endif]-->
	<head>
		<meta charset="utf-8">
		<title>Play Maker Fan Club</title>
					...
					<div class="container">
						<nav class="navbar navbar-default" role="navigation">
							<div class="navbar-header">
								...
								<a class="navbar-brand" href="<?php echo site_url('/'); ?>"><img src="<?php echo base_url('/assets/images/main-logo.png'); ?>" alt=""/></a>
							</div>
