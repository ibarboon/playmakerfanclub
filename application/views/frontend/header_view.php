...
<!--<![endif]-->
	<head>
		<meta charset="utf-8">
		<title>สนามฟุตบอล Play Maker</title>
		<meta name="description" content="สนามฟุตบอล Play Maker">
		<meta name="author" content="สนามฟุตบอล Play Maker">
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div id="contactBloc" class="clearfix">
									...
									<span class="contactPhone"><i class="icon-mobile"></i>(089)-982-2021</span>
								</div>
							</div>
						</div>
					</div>
						...
						<nav class="navbar navbar-default scrollMenu" role="navigation">
							...
							<div class="collapse navbar-collapse" id="mainMenu">
								<ul class="nav navbar-nav pull-right">
									<li class="primary">
										<a href="<?php echo site_url('home'); ?>" class="firstLevel active">Home</a>
									</li>
									<li class="sep"></li>
									<li class="primary"> 
										<a href="<?php echo site_url('playmaker-academy'); ?>" class="firstLevel" >Playmaker Academy</a>
									</li>
									<li class="sep"></li>
									<li class="primary"> 
										<a href="<?php echo site_url('rate-and-promotion'); ?>" class="firstLevel" >Rate & Promotion</a>
									</li>
									<li class="sep"></li>
									<li class="primary"> 
										<a href="<?php echo site_url('league-and-tournament'); ?>" class="firstLevel" >League & Tournament</a>
									</li>
									<li class="sep"></li>
									<li class="primary"> 
										<a href="<?php echo site_url('new-and-event'); ?>" class="firstLevel" >New & Event</a>
									</li>
									<li class="sep"></li>
									<li id="lastMenu" class="last">
										<a href="<?php echo site_url('contact-us'); ?>" class="firstLevel last">Contact Us</a>
									</li>
								</ul>
							</div>
						</nav>
