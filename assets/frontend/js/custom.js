...
jQuery(function($){
	...
	if($('#superSizedSlider').length){
		...
		$.supersized({
                    ...
                    {image : './assets/frontend/images/slider/super/supersized-1.jpg', title : '<h1>We are creative website</h1><a href="#team" class="btn btn-primary">learn more</a>', thumb : '', url : ''},
                    {image : './assets/frontend/images/slider/super/supersized-3.jpg', title : '<h1>We build beautiful websites</h1><a href="#works" class="btn btn-primary">check our portfolio</a>', thumb : '', url : ''},
                    {image : './assets/frontend/images/slider/super/supersized-1.jpg', title : '<h1>That\'s how we like it</h1><a href="#contact" class="btn btn-primary">call us</a>', thumb : '', url : ''}
                    ],
